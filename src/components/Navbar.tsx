          ...
          <div className="flex flex-col h-full relative">
            ...
            <div className="p-6 border-t border-gray-200/50 bg-white/50 space-y-4">
              <Link
                ...
                className="w-full block py-4 px-6 rounded-xl bg-linear-to-r from-orange-500 to-orange-400 text-white font-semibold hover:from-orange-600 hover:to-orange-500 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
              >
